...
import {getImagesList,readTextFile,removeEmptyValues,
    readStructureRecoursve,
    removeUndefinedValues,readXMLFile,
    resolveParents,IGNORE,config, getJSONData, readImages, removeDummyRaces, removeIgnoredEntities, removeOtherRaceEntities, removeUnusedAbilityCommands, resolveActorsEvents, resolveImagesTags, simplifyUnitsCommandCards} from "./data-parser.mjs";
